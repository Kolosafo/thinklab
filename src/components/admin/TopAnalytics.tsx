      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="md:col-span-2 lg:col-span-1">
          <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
            ...
            <div>
              <h5 className="text-xl text-gray-600 text-center">Overall</h5>
              ...
              <span className="block text-center text-gray-500">
                Compared to last year ₦91,988,456
              </span>
            </div>
            <table className="w-full text-gray-600">
              <tbody>
                <tr>
                  <td className="py-2">Houses</td>
                ...
                <tr>
                  <td className="py-2">Lands</td>
                  <td className="text-gray-500">134</td>
                  <td>
                    <svg
                      className="w-16 ml-auto"
                      viewBox="0 0 68 21"
                ...
                <tr>
                  <td className="py-2">Consultations</td>
        ...
        <div>
          <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
            <h5 className="text-xl text-gray-700">Appointments</h5>
            <div className="my-8">
        ...
        <div>
          <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
            ...
            <div className="mt-6">
              <h5 className="text-xl text-gray-700 text-center">Sales</h5>
              <div className="mt-2 flex justify-center gap-4">
            ...
            <table className="mt-6 -mb-2 w-full text-gray-600">
              <tbody>
                <tr>
                  <td className="py-2">Terrace Duplex</td>
                ...
                <tr>
                  ...
                  <td className="text-gray-500">11</td>
                  <td>
                    <svg
                      className="w-16 ml-auto"
                      viewBox="0 0 68 21"
