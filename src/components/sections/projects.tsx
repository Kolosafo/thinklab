      ...
      <Container>
        <div className='mb-12 text-center'>
          ...
          <p className='mx-auto max-w-2xl text-gray-600'>
            Experience next-generation smart homes that blend innovative design
            with cutting-edge technology. Our projects showcase our commitment
            to quality and passion for creating extraordinary living spaces.
          </p>
        </div>
